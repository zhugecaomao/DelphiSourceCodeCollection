...
uses
  ...
  Buttons, Grids, DBGrids,SaleReturnRep;

type
  TSaleReturnForm = class(TForm)
    Bevel1: TBevel;
    Label1: TLabel;
...
var
  SaleReturnForm: TSaleReturnForm;

implementation

{$R *.dfm}

procedure TSaleReturnForm.BitBtn2Click(Sender: TObject);
begin
  Close;
end;

procedure TSaleReturnForm.BitBtn1Click(Sender: TObject);
 var j,k:integer;
begin
...
procedure TSaleReturnForm.BitBtn7Click(Sender: TObject);
var j:integer;
begin
...
procedure TSaleReturnForm.BitBtn4Click(Sender: TObject);
begin
   Table1.Prior;
end;

procedure TSaleReturnForm.BitBtn5Click(Sender: TObject);
begin
   Table1.Next;
end;

procedure TSaleReturnForm.BitBtn3Click(Sender: TObject);
begin
...
procedure TSaleReturnForm.FormCreate(Sender: TObject);
  var i:integer;
begin
...
procedure TSaleReturnForm.Table1AfterScroll(DataSet: TDataSet);
var i,j,k:integer;
begin
       if DBEdit1.Text<>'' then DBEdit1.ReadOnly:=True;
       with StringGrid1 do
...
procedure TSaleReturnForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TSaleReturnForm.BitBtn8Click(Sender: TObject);
 var j:integer;
...
procedure TSaleReturnForm.BitBtn6Click(Sender: TObject);
begin
    Application.CreateForm(TSaleReturnRepF,SaleReturnRepF);

    SaleReturnRep.SaleReturnRepF.QuickRep1.Preview;
end;
