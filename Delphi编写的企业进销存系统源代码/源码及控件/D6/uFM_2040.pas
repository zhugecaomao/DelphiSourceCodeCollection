...
//明细档的日期选择
  ...
  if DBGrid1.SelectedField = Table2F02 then begin
     //select_data(DataSource2,'物料点选窗口','select F01 as 物料编号,F02 as 品名, F03 as 规格,F07 as 参考价格 from T1060','STK0311',['F02','f04'],[0,3],[]);
...
begin
  inherited;
  Search_MasterDetailex(table1,[0,1,1,2],table2,[3,4,8],[0,1,2,9],[3,4,5,7,8],['T5010','T1060'],['F01','F01'],['F02','F02,F03'],['厂商名称','品名,规格'],['M.F03','D.F02'],'');
end;
