...
begin
  ...
  if DBGrid1.SelectedField = Table2F06 then  begin
    if Select_Data(DataSource2,'制令单选取窗口','select M.F01 as 制令单号,'
                ...
                +'left join T1080 as P ON M.F03=P.AutoNo where M.F07<M.F06 and M.F09=''成品''',
...
begin
  inherited;
  Search_MasterDetailex(table1,[0,1,1,2,3],table2,[3,6],[0,1,2,3],[3,6,17],['T1080'],['AutoNo'],['F01,F02,F03,F04,F05,F07'],['型号,品名,材质,规格,心孔,单重'],['D.F02'],'');
end;
