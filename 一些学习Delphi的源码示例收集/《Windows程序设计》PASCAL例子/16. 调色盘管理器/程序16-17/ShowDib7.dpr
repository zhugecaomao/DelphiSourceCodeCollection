            ...
            begin
             ...
             // 装入成功..
              ...
              begin
               ...
               // DIB -> DDB
                hBitmap := CreateDIBitmap(hdcWnd, PBitmapInfoHeader(pPackedDib)^,
                  CBM_INIT, PChar(PackedDibGetBitsPtr(pPackedDib)), pPackedDib^,
                  DIB_RGB_COLORS);
              ...
              begin
                MessageBox(hWnd, 'Cannot load DIB file', szAppName, 0);  // 装入失败..
              end;
             // 刷新窗体 
...
begin
 ...
 // 建立窗体
  hWnd := CreateWindow(szAppName, 'Show DIB #7: Converted to DDB',
                       WS_OVERLAPPEDWINDOW,
