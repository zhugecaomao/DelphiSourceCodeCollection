...
type
  TDocumentsClauseAdd_frm = class(TBaseFrm)
...
var
  DocumentsClauseAdd_frm: TDocumentsClauseAdd_frm;
...
procedure TDocumentsClauseAdd_frm.btnSelClick(Sender: TObject);
...
procedure TDocumentsClauseAdd_frm.btnOKClick(Sender: TObject);
begin
  inherited;
//
...
procedure TDocumentsClauseAdd_frm.btncloseClick(Sender: TObject);
begin
  inherited;
  CLOSE();
end;

procedure TDocumentsClauseAdd_frm.DBGridCellClick(Column: TColumnEh);
begin
  inherited;
//
end;

procedure TDocumentsClauseAdd_frm.FormShow(Sender: TObject);
begin
  inherited;
//
...
procedure TDocumentsClauseAdd_frm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  Case Key of
...
procedure TDocumentsClauseAdd_frm.DBGridDblClick(Sender: TObject);
begin
  inherited;
//
  ...
  begin
     if Flag ='1' then
     begin
        DocumentsClause_frm.Update_ProductDetail(Query.FieldByName('ProductID').AsString, '');
        close();
     end
     else    
     begin
       // with ClientContract_frm.StrGrid do
        begin
          DocumentsClause_frm.Insert_ProductDetail(Query.FieldByName('ProductID').AsString, '');
...
procedure TDocumentsClauseAdd_frm.MenuItem1Click(Sender: TObject);
begin
  inherited;
//产品详细信息.
end;

procedure TDocumentsClauseAdd_frm.DBGridKeyDown(Sender: TObject;
