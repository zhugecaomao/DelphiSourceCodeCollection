...
{the main class}
  TMyLabel = class(TCustomLabel) // TControl  TCustomLabel
  private
    FPen: TPen;
    FBrush: TBrush;
...
procedure TMyLabel.SetPen(Value: TPen);
begin
  FPen.Assign(Value);
end;
...
procedure TMyLabel.StyleChanged(Sender: TObject);
begin
  Invalidate;
end;
...
procedure TMyLabel.MouseDown(Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
...
procedure TMyLabel.KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  //if Assigned(FOnKeyDown) then FOnKeyDown(Self, Key, Shift);
end;

procedure TMyLabel.SetCanMove(const val: Boolean);
begin
...
function TMyLabel.GetCanMove: Boolean;
begin
  result:=FCanMove;
end;
{
...
procedure TMyLabel.SetIndex(const Value: Integer);
begin
  if FIndex<>value then
    FIndex := Value;
end;

procedure TMyLabel.SetSelect(const Value: Boolean);
begin
...
procedure TMyLabel.SetFFocused(const Value: Boolean);
begin
...
procedure TMyLabel.SetFNum(const Value: Integer);
begin
