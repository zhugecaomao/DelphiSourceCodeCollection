...
//
//  last change : 9. Oct. 1998 by Erik Unger
//
//  As in my conversions of DirectX and Glide,
//  I have changed the names of the types in this (Mike's) Unit
//  from GLenum to TGLenum and so on, to give them a more Delphi-like style.
//
//  The parameters of all 'v' vector-functions (glColor4bv...) and many other
//  functions are using VAR and CONST 'T' Types instead of 'P' pointer-types:
//
//  Original: procedure glColor4bv(v: PGLbyte); --> glColor4bv(@MyArray[0]);
//  Changed: procedure glColor4bv(var v: TGLbyte);--> glColor4bv(MyArray[0]);
//
...
type TRCOptions = set of (opDoubleBuffered,opGDI,opStereo);
     ...
     TGLboolean   = Boolean;   PGLboolean  = ^TGLboolean;
...
type  TGLUNurbs           = record end;
      ...
      TGLUTessCombineProc  = procedure(Coords: TVector3d; VertexData: TVector4p; Weight: TVector4f; var OutData: Pointer); stdcall;
      ...
      TGLUTessCombineDataProc  = procedure(Coords: TVector3d; VertexData: TVector4p; Weight: TVector4f; var OutData: Pointer; UserData: Pointer); stdcall;
...
var glAccum : procedure(op: TGLuint; value: TGLfloat); stdcall;
    ...
    glAreTexturesResident : function(n: TGLsizei; var Textures: TGLuint; var residences: TGLboolean): TGLboolean; stdcall;
    ...
    glDeleteTextures : procedure(n: TGLsizei; var textures: TGLuint); stdcall;
    ...
    glEdgeFlagv : procedure(var flag: TGLboolean); stdcall;
    ...
    glEvalCoord1dv : procedure(var u: TGLdouble); stdcall; 
    glEvalCoord1f : procedure(u: TGLfloat); stdcall; 
    glEvalCoord1fv : procedure(var u: TGLfloat); stdcall; 
    glEvalCoord2d : procedure(u: TGLdouble; v: TGLdouble); stdcall;
    glEvalCoord2dv : procedure(var u: TGLdouble); stdcall; 
    glEvalCoord2f : procedure(u, v: TGLfloat); stdcall; 
    glEvalCoord2fv : procedure(var u: TGLfloat); stdcall;
    ...
    glFeedbackBuffer : procedure(size: TGLsizei; atype: TGLenum; var buffer: TGLfloat); stdcall; 
    glFinish : procedure; stdcall;
    glFlush : procedure; stdcall; 
    glFogf : procedure(pname: TGLenum; param: TGLfloat); stdcall;
    glFogfv : procedure(pname: TGLenum; var params: TGLfloat); stdcall; 
    glFogi : procedure(pname: TGLenum; param: TGLint); stdcall;
    glFogiv : procedure(pname: TGLenum; var params: TGLint); stdcall; 
    ...
    glGenTextures : procedure(n: TGLsizei; var textures: TGLuint); stdcall;
    glGetBooleanv : procedure(pname: TGLenum; var params: TGLboolean); stdcall;
    glGetClipPlane : procedure(plane: TGLenum; var equation: TGLdouble); stdcall;
    glGetDoublev : procedure(pname: TGLenum; var params: TGLdouble); stdcall;
    glGetError : function : TGLuint; stdcall;
    glGetFloatv : procedure(pname: TGLenum; var params: TGLfloat); stdcall;
    glGetIntegerv : procedure(pname: TGLenum; var params: TGLint); stdcall;
    glGetLightfv : procedure(light, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetLightiv : procedure(light, pname: TGLenum; var params: TGLint); stdcall;
    glGetMapdv : procedure(target, query: TGLenum; var v: TGLdouble); stdcall;
    glGetMapfv : procedure(target, query: TGLenum; var v: TGLfloat); stdcall;
    glGetMapiv : procedure(target, query: TGLenum; var v: TGLint); stdcall;
    glGetMaterialfv : procedure(face, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetMaterialiv : procedure(face, pname: TGLenum; var params: TGLint); stdcall;
    glGetPixelMapfv : procedure(map: TGLenum; var values: TGLfloat); stdcall;
    glGetPixelMapuiv : procedure(map: TGLenum; var values: TGLuint); stdcall;
    glGetPixelMapusv : procedure(map: TGLenum; var values: TGLushort); stdcall;
    glGetPointerv : procedure(pname: TGLenum; var params: Pointer); stdcall;
    glGetPolygonStipple : procedure(var mask: TGLubyte); stdcall;
    glGetString : function(name: TGLenum): PChar; stdcall;
    glGetTexEnvfv : procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetTexEnviv : procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glGetTexGendv : procedure(coord, pname: TGLenum; var params: TGLdouble); stdcall;
    glGetTexGenfv : procedure(coord, pname: TGLenum; var params: TGLfloat); stdcall; 
    glGetTexGeniv : procedure(coord, pname: TGLenum; var params: TGLint); stdcall;
    glGetTexImage : procedure(target: TGLenum; level: TGLint; format, atype: TGLenum; pixels: Pointer); stdcall; 
    glGetTexLevelParameterfv : procedure(target: TGLenum; level: TGLint; pname: TGLenum; var params: TGLfloat); stdcall;
    glGetTexLevelParameteriv : procedure(target: TGLenum; level: TGLint; pname: TGLenum; var params: TGLint); stdcall;
    glGetTexParameterfv : procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetTexParameteriv : procedure(target, pname: TGLenum; var params: TGLint); stdcall; 
    ...
    glIndexdv : procedure(var c: TGLdouble); stdcall; 
    glIndexf : procedure(c: TGLfloat); stdcall; 
    glIndexfv : procedure(var c: TGLfloat); stdcall; 
    glIndexi : procedure(c: TGLint); stdcall; 
    glIndexiv : procedure(var c: TGLint); stdcall;
    glIndexs : procedure(c: TGLshort); stdcall;
    glIndexsv : procedure(var c: TGLshort); stdcall;
    glIndexub : procedure(c: TGLubyte); stdcall; 
    glIndexubv : procedure(var c: TGLubyte); stdcall; 
    ...
    glLightModelfv : procedure(pname: TGLenum; var params: TGLfloat); stdcall;
    glLightModeli : procedure(pname: TGLenum; param: TGLint); stdcall;
    glLightModeliv : procedure(pname: TGLenum; var params: TGLint); stdcall;
    glLightf : procedure(light, pname: TGLenum; param: TGLfloat); stdcall;
    glLightfv : procedure(light, pname: TGLenum; var params: TGLfloat); stdcall;
    glLighti : procedure(light, pname: TGLenum; param: TGLint); stdcall;
    glLightiv : procedure(light, pname: TGLenum; var params: TGLint); stdcall;
    ...
    glLoadMatrixd : procedure(var m: TGLdouble); stdcall;
    glLoadMatrixf : procedure(var m: TGLfloat); stdcall;
    glLoadName : procedure(name: TGLuint); stdcall; 
    glLogicOp : procedure(opcode: TGLenum); stdcall;
    glMap1d : procedure(target: TGLenum; u1, u2: TGLdouble; stride, order: TGLint; var points: TGLdouble); stdcall;
    glMap1f : procedure(target: TGLenum; u1, u2: TGLfloat; stride, order: TGLint; var points: TGLfloat);   stdcall;
    glMap2d : procedure(target: TGLenum; u1, u2: TGLdouble; ustride, uorder: TGLint; v1, v2: TGLdouble; vstride, vorder: TGLint; var points: TGLdouble); stdcall;
    glMap2f : procedure(target: TGLenum; u1, u2: TGLfloat; ustride, uorder: TGLint; v1, v2: TGLfloat; vstride, vorder: TGLint; var points: TGLfloat); stdcall;
    ...
    glMaterialfv : procedure(face, pname: TGLenum; var params: TGLfloat); stdcall;
    glMateriali : procedure(face, pname: TGLenum; param: TGLint); stdcall;
    glMaterialiv : procedure(face, pname: TGLenum; var params: TGLint); stdcall;
    glMatrixMode : procedure(mode: TGLenum); stdcall;
    glMultMatrixd : procedure(var m: TGLdouble); stdcall;
    glMultMatrixf : procedure(var m: TGLfloat); stdcall;
    glNewList : procedure(list: TGLuint; mode: TGLenum); stdcall;
    glNormal3b : procedure(nx, ny, nz: TGLbyte); stdcall;
    glNormal3bv : procedure(var v: TGLbyte); stdcall;
    glNormal3d : procedure(nx, ny, nz: TGLdouble); stdcall;
    glNormal3dv : procedure(var v: TGLdouble); stdcall;
    glNormal3f : procedure(nx, ny, nz: TGLfloat); stdcall;
    glNormal3fv : procedure(var v: TGLfloat); stdcall;
    glNormal3i : procedure(nx, ny, nz: TGLint); stdcall;
    glNormal3iv : procedure(var v: TGLint); stdcall;
    glNormal3s : procedure(nx, ny, nz: TGLshort); stdcall;
    glNormal3sv : procedure(var v: TGLshort); stdcall; 
    ...
    glPixelMapfv : procedure(map: TGLenum; mapsize: TGLsizei; var values: TGLfloat); stdcall;
    glPixelMapuiv : procedure(map: TGLenum; mapsize: TGLsizei; var values: TGLuint); stdcall;
    glPixelMapusv : procedure(map: TGLenum; mapsize: TGLsizei; var values: TGLushort); stdcall;
    ...
    glPolygonStipple : procedure(var mask: TGLubyte); stdcall;
    glPopAttrib : procedure; stdcall;
    glPopClientAttrib : procedure; stdcall;
    glPopMatrix : procedure; stdcall;
    glPopName : procedure; stdcall;
    glPrioritizeTextures : procedure(n: TGLsizei; var textures: TGLuint; var priorities: TGLclampf); stdcall;
    ...
    glRasterPos2dv : procedure(var v: TGLdouble); stdcall; 
    glRasterPos2f : procedure(x, y: TGLfloat); stdcall; 
    glRasterPos2fv : procedure(var v: TGLfloat); stdcall; 
    glRasterPos2i : procedure(x, y: TGLint); stdcall; 
    glRasterPos2iv : procedure(var v: TGLint); stdcall;
    glRasterPos2s : procedure(x, y: TGLshort); stdcall;
    glRasterPos2sv : procedure(var v: TGLshort); stdcall; 
    glRasterPos3d : procedure(x, y, z: TGLdouble); stdcall; 
    glRasterPos3dv : procedure(var v: TGLdouble); stdcall; 
    glRasterPos3f : procedure(x, y, z: TGLfloat); stdcall; 
    glRasterPos3fv : procedure(var v: TGLfloat); stdcall; 
    glRasterPos3i : procedure(x, y, z: TGLint); stdcall;
    glRasterPos3iv : procedure(var v: TGLint); stdcall;
    glRasterPos3s : procedure(x, y, z: TGLshort); stdcall; 
    glRasterPos3sv : procedure(var v: TGLshort); stdcall;
    glRasterPos4d : procedure(x, y, z, w: TGLdouble); stdcall; 
    glRasterPos4dv : procedure(var v: TGLdouble); stdcall; 
    glRasterPos4f : procedure(x, y, z, w: TGLfloat); stdcall;
    glRasterPos4fv : procedure(var v: TGLfloat); stdcall;
    glRasterPos4i : procedure(x, y, z, w: TGLint); stdcall;
    glRasterPos4iv : procedure(var v: TGLint); stdcall;
    glRasterPos4s : procedure(x, y, z, w: TGLshort); stdcall; 
    glRasterPos4sv : procedure(var v: TGLshort); stdcall; 
    ...
    glRectdv : procedure(var v1, v2: TGLdouble); stdcall;
    glRectf : procedure(x1, y1, x2, y2: TGLfloat); stdcall;
    glRectfv : procedure(var v1, v2: TGLfloat); stdcall;
    glRecti : procedure(x1, y1, x2, y2: TGLint); stdcall;
    glRectiv : procedure(var v1, v2: TGLint); stdcall;
    glRects : procedure(x1, y1, x2, y2: TGLshort); stdcall; 
    glRectsv : procedure(var v1, v2: TGLshort); stdcall; 
    ...
    glSelectBuffer : procedure(size: TGLsizei; var buffer: TGLuint); stdcall;
    ...
    glTexCoord1dv : procedure(var v: TGLdouble); stdcall;
    glTexCoord1f : procedure(s: TGLfloat); stdcall; 
    glTexCoord1fv : procedure(var v: TGLfloat); stdcall;
    glTexCoord1i : procedure(s: TGLint); stdcall; 
    glTexCoord1iv : procedure(var v: TGLint); stdcall; 
    glTexCoord1s : procedure(s: TGLshort); stdcall;
    glTexCoord1sv : procedure(var v: TGLshort); stdcall;
    glTexCoord2d : procedure(s, t: TGLdouble); stdcall;
    glTexCoord2dv : procedure(var v: TGLdouble); stdcall;
    glTexCoord2f : procedure(s, t: TGLfloat); stdcall; 
    glTexCoord2fv : procedure(var v: TGLfloat); stdcall; 
    glTexCoord2i : procedure(s, t: TGLint); stdcall;
    glTexCoord2iv : procedure(var v: TGLint); stdcall;
    glTexCoord2s : procedure(s, t: TGLshort); stdcall;
    glTexCoord2sv : procedure(var v: TGLshort); stdcall;
    glTexCoord3d : procedure(s, t, r: TGLdouble); stdcall;
    glTexCoord3dv : procedure(var v: TGLdouble); stdcall;
    glTexCoord3f : procedure(s, t, r: TGLfloat); stdcall;
    glTexCoord3fv : procedure(var v: TGLfloat); stdcall;
    glTexCoord3i : procedure(s, t, r: TGLint); stdcall;
    glTexCoord3iv : procedure(var v: TGLint); stdcall;
    glTexCoord3s : procedure(s, t, r: TGLshort); stdcall;
    glTexCoord3sv : procedure(var v: TGLshort); stdcall;
    glTexCoord4d : procedure(s, t, r, q: TGLdouble); stdcall;
    glTexCoord4dv : procedure(var v: TGLdouble); stdcall;
    glTexCoord4f : procedure(s, t, r, q: TGLfloat); stdcall;
    glTexCoord4fv : procedure(var v: TGLfloat); stdcall;
    glTexCoord4i : procedure(s, t, r, q: TGLint); stdcall;
    glTexCoord4iv : procedure(var v: TGLint); stdcall;
    glTexCoord4s : procedure(s, t, r, q: TGLshort); stdcall;
    glTexCoord4sv : procedure(var v: TGLshort); stdcall;
    ...
    glTexEnvfv : procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glTexEnvi : procedure(target, pname: TGLenum; param: TGLint); stdcall; 
    glTexEnviv : procedure(target, pname: TGLenum; var params: TGLint); stdcall; 
    glTexGend : procedure(coord, pname: TGLenum; param: TGLdouble); stdcall; 
    glTexGendv : procedure(coord, pname: TGLenum; var params: TGLdouble); stdcall;
    glTexGenf : procedure(coord, pname: TGLenum; param: TGLfloat); stdcall;
    glTexGenfv : procedure(coord, pname: TGLenum; var params: TGLfloat); stdcall;
    glTexGeni : procedure(coord, pname: TGLenum; param: TGLint); stdcall; 
    glTexGeniv : procedure(coord, pname: TGLenum; var params: TGLint); stdcall;
    ...
    glTexParameterfv : procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glTexParameteri : procedure(target, pname: TGLenum; param: TGLint); stdcall;
    glTexParameteriv : procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    ...
    glVertex2dv : procedure(var v: TGLdouble); stdcall;
    glVertex2f : procedure(x, y: TGLfloat); stdcall;
    glVertex2fv : procedure(var v: TGLfloat); stdcall;
    glVertex2i : procedure(x, y: TGLint); stdcall;
    glVertex2iv : procedure(var v: TGLint); stdcall;
    glVertex2s : procedure(x, y: TGLshort); stdcall;
    glVertex2sv : procedure(var v: TGLshort); stdcall;
    glVertex3d : procedure(x, y, z: TGLdouble); stdcall;
    glVertex3dv : procedure(var v: TGLdouble); stdcall; 
    glVertex3f : procedure(x, y, z: TGLfloat); stdcall; 
    glVertex3fv : procedure(var v: TGLfloat); stdcall; 
    glVertex3i : procedure(x, y, z: TGLint); stdcall; 
    glVertex3iv : procedure(var v: TGLint); stdcall; 
    glVertex3s : procedure(x, y, z: TGLshort); stdcall;
    glVertex3sv : procedure(var v: TGLshort); stdcall;
    glVertex4d : procedure(x, y, z, w: TGLdouble); stdcall;
    glVertex4dv : procedure(var v: TGLdouble); stdcall;
    glVertex4f : procedure(x, y, z, w: TGLfloat); stdcall;
    glVertex4fv : procedure(var v: TGLfloat); stdcall;
    glVertex4i : procedure(x, y, z, w: TGLint); stdcall;
    glVertex4iv : procedure(var v: TGLint); stdcall;
    glVertex4s : procedure(x, y, z, w: TGLshort); stdcall;
    glVertex4sv : procedure(var v: TGLshort); stdcall;
    ...
    glColorTableParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glColorTableParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetColorTable: procedure(target, format, Atype: TGLenum; table: Pointer); stdcall;
    glGetColorTableParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glGetColorTableParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    ...
    glConvolutionParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glConvolutionParameterf: procedure(target, pname: TGLenum; param: TGLfloat); stdcall;
    glConvolutionParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    glGetConvolutionParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glGetConvolutionParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    ...
    glGetHistogramParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glGetHistogramParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
    ...
    glGetMinmaxParameteriv: procedure(target, pname: TGLenum; var params: TGLint); stdcall;
    glGetMinmaxParameterfv: procedure(target, pname: TGLenum; var params: TGLfloat); stdcall;
...
//------------------------------------------------------------------------------
    ...
    gluProject : function(objx, objy, objz: TGLdouble; modelMatrix: TMatrix4d; projMatrix: TMatrix4d; viewport: TVector4i; var winx, winy, winz: TGLdouble): TGLint; stdcall;
    gluUnProject : function(winx, winy, winz: TGLdouble; modelMatrix: TMatrix4d; projMatrix: TMatrix4d; viewport: TVector4i; var objx, objy, objz: TGLdouble): TGLint; stdcall;
    ...
    gluGetTessProperty : procedure(tess: PGLUtesselator; which: TGLenum; var value: TGLdouble); stdcall;
    ...
    gluPwlCurve : procedure(nobj: PGLUnurbs; count: TGLint; var points: TGLfloat; stride: TGLint; atype: TGLenum); stdcall;
    gluNurbsCurve : procedure(nobj: PGLUnurbs; nknots: TGLint; var knot: TGLfloat; stride: TGLint; var ctlarray: TGLfloat; order: TGLint; atype: TGLenum); stdcall;
    gluNurbsSurface : procedure(nobj: PGLUnurbs; sknot_count: TGLint; var sknot: TGLfloat; tknot_count: TGLint; var tknot: TGLfloat; s_stride, t_stride: TGLint; var ctlarray: TGLfloat; sorder, torder: TGLint; atype: TGLenum); stdcall;
    ...
    gluGetNurbsProperty : procedure(nobj: PGLUnurbs; aproperty: TGLenum; var value: TGLfloat); stdcall;
...
//------------------------------------------------------------------------------
    ...
    wglUseFontOutlinesA : function(p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer; var p8: TGlyphMetricsFloat): BOOL; stdcall;
    wglUseFontOutlinesW : function(p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer; var p8: TGlyphMetricsFloat): BOOL; stdcall;
    wglUseFontOutlines : function(p1: HDC; p2, p3, p4: DWORD; p5, p6: Single; p7: Integer; var p8: TGlyphMetricsFloat): BOOL; stdcall;
    ChoosePixelFormat : function(DC: HDC; var PFD: TPixelFormatDescriptor): Integer; stdcall;
    DescribePixelFormat : function(DC: HDC; p2: Integer; p3: UINT; var PFD: TPixelFormatDescriptor): Integer; stdcall;
...
//------------------------------------------------------------------------------
    ...
    glAreTexturesResidentEXT : function(n: TGLsizei; var textures: TGLuint; var residences: TGLBoolean): TGLboolean; stdcall;
    ...
    glCullParameterfvEXT : procedure(pname: TGLenum; var params: TGLfloat); stdcall;
    glCullParameterdvEXT : procedure(pname: TGLenum; var params: TGLdouble); stdcall;
    glDeleteTexturesEXT : procedure(n: TGLsizei; var textures: TGLuint); stdcall;
    glDrawArraysEXT : procedure(mode: TGLenum; first: TGLint; count: TGLsizei); stdcall;
    glEdgeFlagPointerEXT : procedure(stride, count: TGLsizei; var data: TGLboolean); stdcall;
    glEndSceneEXT : procedure; stdcall;
    glGenTexturesEXT : procedure(n: TGLsizei; var textures: TGLuint); stdcall;
    glGetColorTableEXT : procedure(target, format, atype: TGLenum; data: Pointer); stdcall;
    glGetColorTablePameterfvEXT : procedure(target, pname: TGLenum; var params: Pointer); stdcall;
    glGetColorTablePameterivEXT : procedure(target, pname: TGLenum; var params: Pointer); stdcall;
    glGetPointervEXT : procedure(pname: TGLenum; var params: Pointer); stdcall;
    ...
    glPrioritizeTexturesEXT : procedure(n: TGLsizei; var textures: TGLuint; var priorities: TGLclampf); stdcall;
