object frmPsnLcnList: TfrmPsnLcnList
  ...
  object grdList: TdxDBGrid
    ...
    object grdListsysid: TdxDBGridMaskColumn
      Visible = False
      Width = 68
      BandIndex = 0
      RowIndex = 0
    ...
    object grdListlicnsno: TdxDBGridMaskColumn
      Width = 124
      BandIndex = 0
      RowIndex = 0
      FieldName = 'licnsno'
    end
    object grdListperson_sysid: TdxDBGridMaskColumn
      Visible = False
      Width = 68
      BandIndex = 0
      RowIndex = 0
    ...
    object grdListperson_name: TdxDBGridMaskColumn
      Width = 63
      BandIndex = 0
      RowIndex = 0
      FieldName = 'person_name'
    end
    object grdListlicns_kind_code: TdxDBGridMaskColumn
      Visible = False
      Width = 53
      BandIndex = 0
      RowIndex = 0
    ...
    object grdListlicns_kind_name: TdxDBGridMaskColumn
      Width = 90
      BandIndex = 0
      RowIndex = 0
      FieldName = 'licns_kind_name'
    end
    object grdListlicns_category_code: TdxDBGridMaskColumn
      Visible = False
      Width = 67
      BandIndex = 0
      RowIndex = 0
    ...
    object grdListlicns_category_name: TdxDBGridMaskColumn
      Width = 89
      BandIndex = 0
      RowIndex = 0
      FieldName = 'licns_category_name'
    end
    object grdListlicns_state_name: TdxDBGridMaskColumn
      Width = 79
      BandIndex = 0
      RowIndex = 0
      FieldName = 'licns_state_name'
    end
    object grdListorgan_sysid: TdxDBGridMaskColumn
      Visible = False
      Width = 68
      BandIndex = 0
      RowIndex = 0
    ...
    object grdListorgan_sysid_name: TdxDBGridMaskColumn
      Width = 174
      BandIndex = 0
      RowIndex = 0
      FieldName = 'organ_sysid_name'
    end
    object grdListissue_date: TdxDBGridMaskColumn
      BandIndex = 0
      RowIndex = 0
      FieldName = 'issue_date'
    end
    object grdListlicns_state: TdxDBGridMaskColumn
      Visible = False
      Width = 40
      BandIndex = 0
      RowIndex = 0
  ...
  object List: TCSADOQuery
    ...
    object Listlicnsno: TStringField
      DisplayLabel = #36164#36136#35777#20070#32534#21495
      FieldName = 'licnsno'
    end
    object Listperson_sysid: TStringField
      FieldName = 'person_sysid'
    end
    object Listperson_name: TStringField
      DisplayLabel = #20154#21592#22995#21517
      FieldName = 'person_name'
      Size = 30
    end
    object Listlicns_kind_code: TStringField
      FieldName = 'licns_kind_code'
      Size = 4
    end
    ...
    object Listlicns_category_code: TStringField
      FieldName = 'licns_category_code'
      Size = 4
    end
    ...
    object Listissue_date: TStringField
      DisplayLabel = #21457#35777#26085#26399
      FieldName = 'issue_date'
      Size = 10
    end
    object Listlicns_state: TStringField
      FieldName = 'licns_state'
      Size = 2
    end
    object Listlicns_state_name: TStringField
      DisplayLabel = #36164#36136#35777#20070#29366#24577
      FieldName = 'licns_state_name'
    end
  end
