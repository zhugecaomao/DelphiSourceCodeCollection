...
type
  TfrmWeekWarerHouseView = class(TfrmViewDataBase)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
...
var
  ...
  frmWeekWarerHouseView: TfrmWeekWarerHouseView;
...
procedure TfrmWeekWarerHouseView.prop_IniData;
var
  ls_Date: String;
begin
  inherited;
...
procedure TfrmWeekWarerHouseView.prop_IniInterFace;
begin
  inherited;
...
function TfrmWeekWarerHouseView.prif_GetLastDate(
...
procedure TfrmWeekWarerHouseView.atNewExecute(Sender: TObject);
begin
  inherited;   
  prip_SetControlFalse;
  Fi_Act := 1;
...
procedure TfrmWeekWarerHouseView.atEditExecute(Sender: TObject);
begin
  inherited;  
  prip_SetControlFalse;
  Fi_Act := 2;
...
procedure TfrmWeekWarerHouseView.atDelExecute(Sender: TObject);
begin
  inherited;
  prip_SetControlFalse;
  Fi_Act := 3;
...
procedure TfrmWeekWarerHouseView.prip_GetDayWarerHouse(As_LastDate, As_Date: String);
var
  ls_SQL: String;
begin
  with Viewq do
...
function TfrmWeekWarerHouseView.prif_CanGetData: Boolean;
begin
  case Fi_Act of
    1:
    begin
...
procedure TfrmWeekWarerHouseView.bbtnStartClick(Sender: TObject);
var
  ls_LastDate: String;
begin
  inherited;
...
procedure TfrmWeekWarerHouseView.atCancelExecute(Sender: TObject);
begin
  inherited;
  prip_SetControlFalse;
end;

procedure TfrmWeekWarerHouseView.prip_SetControlFalse;
begin
...
procedure TfrmWeekWarerHouseView.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  frmWeekWarerHouseView := nil;
end;

procedure TfrmWeekWarerHouseView.prip_GetEidtDayWarerHouse(As_Date: String); 
begin
  with Viewq do
  begin
    if Active then Close;
...
procedure TfrmWeekWarerHouseView.prip_Save(As_Date: String);
var
  ls_SQL: String;
begin
...
procedure TfrmWeekWarerHouseView.atSaveExecute(Sender: TObject); 
var
  ls_Date: String;
begin
  inherited;
...
procedure TfrmWeekWarerHouseView.memViewBeforePost(DataSet: TDataSet);
begin
  inherited;
  {with memView do
  begin
