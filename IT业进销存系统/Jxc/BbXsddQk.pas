...
type
  TfrmBbXsddQk = class(TfrmComTjfx)
    Series1: TPieSeries;
    Shape1: TShape;
    Label2: TLabel;
    Shape2: TShape;
...
procedure TfrmBbXsddQk.FormShow(Sender: TObject);
begin
...
procedure TfrmBbXsddQk.OpendataSet;
begin
  dsJbzl.Close;
  dsJbzl.CommandText :=
...
procedure TfrmBbXsddQk.aMxExecute(Sender: TObject);
begin
  OpenXsdd(dsJbzl['ID']);
end;

procedure TfrmBbXsddQk.DBGrid1DrawColumnCell(Sender: TObject;
