...
procedure TfrmBbKhXsMx.FormShow(Sender: TObject);
begin
...
procedure TfrmBbKhXsMx.IniRecord;
begin
  dsMx.CommandText :=
...
procedure TfrmBbKhXsMx.aDjExecute(Sender: TObject);
begin
  OpenDj(dsMx['LX'], dsMx['ZBID']);
end;

procedure TfrmBbKhXsMx.SetButton;
begin
  inherited;
  aDj.Enabled := (aDj.Tag = 0) and not (dsMx.IsEmpty);
end;

procedure TfrmBbKhXsMx.DBGrid1DrawColumnCell(Sender: TObject;
