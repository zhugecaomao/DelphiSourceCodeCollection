...
type
  TGameZone = record
    ...
    sGameIPaddr: string[50];
    nGameIPPort: Integer;
    sNoticeUrl: string[100];
  end;
  pTGameZone = ^TGameZone;
var
  m_SelGameZone: pTGameZone;
  m_BoSearchFinish: Boolean = False;
  m_boClientSocketConnect: Boolean = False;
  m_GameList: TList = nil;
  m_LocalGameList: TList = nil;
  m_sMirClient: string;
...
resourcestring
  CreateUlrName = 'Æ®Æ®ÍøÓÎ´«ÆæµÇÂ½Æ÷';
  HomePage = 'http://www.51ggame.com';
  m_sRemoteAddress = 'http://www.51ggame.com/GameList.txt';
  FalshUrl = 'http://www.51ggame.com/MirFalsh.swf';
  sProgamFile = 'MirClient.Dat';
  mClientName = '51ggame.dll';
  m_sGameListName = 'GameList.txt';
  m_sLocalGameListName = 'LocalGameList.txt';
implementation
